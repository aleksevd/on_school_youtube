...
Rails.application.config.assets.precompile += %w( admin.js admin.css tinymce/plugins/uploadimage/plugin.js tinymce/plugins/uploadimage/langs/en.js lightbox/*)
